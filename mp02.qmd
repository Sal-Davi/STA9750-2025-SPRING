...
agencies <- agencies |>
  mutate(
    ...
    total_co2_emissions = 
      ...
      (liqpetgas           * 12.68) +  
      # For electric usage, you might multiply MWh by the state-specific CO2 factor:
...
2023 Fuel and energy. (n.d.). [FTA](https://www.transit.dot.gov/ntd/data-product/2023-fuel-and-energy)
rgy)
