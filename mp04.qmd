...
results_2020_clean <- results_2020_all |>
  ...
  rename(
    ...
    `%_for_trump_2020` = donald_trump_republican_2,
    ...
    `%_for_others_2020`    = various_candidates_other_parties_2,
    `winning_%_2020`           = margin_2,
    margin_2020               = margin,
    total_during_2020                = total
  ) |>
  filter(
    trump_votes_2020 != "#",
    county != "Totals"
...
results_2024_clean <- results_2024_all |>
  ...
  rename(
    ...
    `trump_got_2024` = donald_trump_republican_2,
    votes_harris_got_2024    = kamala_harris_democratic,
    `%_for_harris_2024`= kamala_harris_democratic_2,
    other_parties_2024        = various_candidates_other_parties,
    `%_for_others_2024`    = various_candidates_other_parties_2,
    `winning%_in_2024`           = margin_2,
    margin_2024               = margin,
...
# 1) Compute top 5 counties by Biden share in 2020, keeping numeric share for plotting
top5_biden_2020 <- full_data |>
  mutate(
    biden_votes_2020 = as.numeric(gsub(",", "", votes_for_biden_2020)),
    total_votes_2020 = as.numeric(gsub(",", "", total_during_2020)),
...
top5_trump_shift <- full_election |>
  mutate(
    votes_trump_2020   = as.numeric(gsub(",", "", trump_votes_2020)),
    votes_trump_2024   = as.numeric(gsub(",", "", trump_votes_2024 )),
    total_votes_2020   = as.numeric(gsub(",", "", total_during_2020)),
    total_votes_2024   = as.numeric(gsub(",", "", total_during_2024)),
...
results_2020_clean |>
  mutate(
    ...
    total20     = as.numeric(str_remove_all(total_during_2020, ","))
  ) |>
  group_by(state) |>
  summarize(
...
top5_turnout_increase <- full_data |>
  mutate(
    turnout_2020   = as.numeric(gsub(",", "", total_during_2020)),
...
shift_data <- full_data |>
  mutate(
    ...
    total_during_2020         = as.numeric(str_remove_all(total_during_2020,               ",")),
    total_during_2024         = as.numeric(str_remove_all(total_during_2024,               ",")),
    
    percent_for_trump_20       = votes_trump_2020 / total_during_2020,
    percent_for_trump_24      = votes_trump_2024 / total_during_2024,
    percent_for_biden_20       = votes_biden_2020 / total_during_2020,
